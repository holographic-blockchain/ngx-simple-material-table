...
export class HbMatTableColumn {
    ...
    /** The CSS class value which should be applied directly to the cell elements. Will be applied to header, body and footer. */
    @Input() columnClass: string | undefined = undefined;
